...
Exemplo de componente de calculo de Estatísticas e Cálculo do Quadro de Quartil DLL em C# .NET para ser utilizado como componente em outras linguaguens de programação 32bits como componente (**COM/ActiveX**).
